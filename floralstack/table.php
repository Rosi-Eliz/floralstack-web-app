        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: linear-gradient(var(--success), var(--success) 0%, rgb(22,150,104) 100%), var(--cyan);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#" style="font-family: Nunito, sans-serif;">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="table.html"><i class="fas fa-table"></i><span>Plants</span></a></li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold" style="color: var(--blue);filter: hue-rotate(0deg) saturate(0%);">Plants Info</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <nav class="d-lg-flex justify-content-lg-end dataTables_paginate paging_simple_numbers">
                                        <ul class="pagination">
                                            ...
                                            <li class="page-item active" style="background: var(--blue);opacity: 1;"><a class="page-link" href="#">1</a></li>
